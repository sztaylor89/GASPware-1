...
gnu: OPT = "GNU_CC=gcc-7" "GNU_FOR=gfortran-7 @../../etc/gfort.cfg" "GS_ONLINE=" "GS_AIO=-DUSE_AIO" "GS_OPT=-O2" gnu
gnu: MAKE = make
...
pgi: OPT =  "GS_ONLINE=" "GS_AIO=-DUSE_AIO" "GS_OPT=-O2" pgi
pgi: MAKE = make
pgi: Libr Cmat Gsort Recal Sadd Stopp Tape Xtrack
